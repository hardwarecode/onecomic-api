...
from onecomic.utils.mail import Mail
from onecomic.cli import download_main
from onecomic.worker import run_in_background
...
def add_task(site, comicid, params):
    ...
    pre_time = datetime.datetime.utcnow() - datetime.timedelta(seconds=config.TASK_AVOID_REPEAT_TIME)
